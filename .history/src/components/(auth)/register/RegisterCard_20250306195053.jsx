...
export default function RegisterCard() {
  ...
  const handleRegister = () => {
    setLoading(true);
    // Simulate a loading state then redirect based on user category
    setTimeout(() => {
      setLoading(false);
      if (userCategory === 'Resident') {
        router.push('/register/resident');
      } else if (userCategory === 'Commercial') {
        router.push('/register/commercial');
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-white flex flex-col items-center justify-center py-8 px-4">
        ...
        <hr className="w-full border border-gray-200 mb-8" />
        ...
        <div className="w-full max-w-md">
          ...
          <hr className="w-full border border-gray-200 mb-8" />{/* This line break should now show correctly */}
