...
export default function EmailModal({ closeModal }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="relative bg-white rounded-lg w-full max-w-md p-16 space-y-4">
        <img
        ...
        <p style={{ fontFamily: 'SF Pro Text, sans-serif', fontWeight: 400, fontSize: '14px', lineHeight: '150%', letterSpacing: '-5%', textAlign: 'center', color: '#1E1E1E', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
          We've sent an email with a 6-digit OTP to your email, <span style={{ fontFamily: 'SF Pro Text, sans-serif', fontWeight: 800, fontSize: '14px', lineHeight: '150%', letterSpacing: '-5%', color: '#1E1E1E', wordBreak: 'break-all' }}>
            {userEmail}
