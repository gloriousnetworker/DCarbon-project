...
export default function StepOneCard() {
  ...
  const partnerType = 'installer';
  const router = useRouter();

  const handleSubmit = async () => {
    // Validate required fields (partnerType is fixed)
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div>
            ...
            <input
              ...
              value="Installer"
              disabled
              className="w-full rounded-md border border-gray-300 bg-gray-100 px-3 py-2 text-sm focus:outline-none font-sfpro text-[14px] leading-[100%] tracking-[-0.05em] font-[400] text-[#626060]"
            />
          </div>
