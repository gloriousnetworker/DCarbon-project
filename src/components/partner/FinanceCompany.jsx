...
export default function StepOneCard() {
  ...
  // Fixed partner type: finance_company
  const [partnerType] = useState('finance_company');
  ...
  const handleSubmit = async () => {
    ...
    if (!partnerName || !phoneNumber || !email || !address) {
    ...
    <>
      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center py-8 px-4 bg-white">
        ...
        <div className="w-full max-w-md space-y-6">
          {/* Partner Type (static) */}
          <div>
            <label className="block mb-2 font-sfpro text-[14px] font-[400] text-[#1E1E1E]">
              Partner Type
            </label>
            <div className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm font-sfpro text-[14px] text-[#626060] bg-gray-100">
              Finance Company
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#039994] font-sfpro text-[14px] text-[#1E1E1E]"
              required
            />
          </div>
        ...
        <div className="mt-6 text-center font-sfpro text-[10px] font-[800] underline text-[#1E1E1E]">
