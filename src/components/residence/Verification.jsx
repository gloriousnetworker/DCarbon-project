...
const styles = {
  ...
  title:
    "mb-4 font-[600] text-[32px] leading-[100%] text-[#039994] font-sfpro text-center",
  progressBarContainer:
    "w-full max-w-md bg-gray-200 rounded-full h-2 overflow-hidden mb-4",
  progressBar: "bg-[#039994] h-2 rounded-full transition-all duration-300",
  buttonPrimary:
    "w-full max-w-md rounded-md bg-[#039994] text-white font-semibold py-2 mt-4 hover:bg-[#02857f] focus:outline-none focus:ring-2 focus:ring-[#039994] font-sfpro",
  buttonSkip:
    "w-full max-w-md rounded-md border border-[#039994] text-[#039994] font-semibold py-2 mt-2 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#039994] font-sfpro",
...
export default function VerificationContent({ token: propToken }) {
  ...
  const handleVerify = async () => {
    ...
    // Open external authorize URL in new tab
    window.open(
      "https://utilityapi.com/authorize/DCarbon_Solutions",
      "_blank",
      "noopener"
    );
    ...
    try {
      ...
      setMessage(
        data.message || "Utility authorization verified successfully"
      );
  ...
  return (
    <div className={styles.container}>
      ...
      <p className="mb-6 text-center font-sfpro text-gray-600 max-w-md">
        Please authorize your utility account to continue registration or skip
        to proceed.
      </p>
