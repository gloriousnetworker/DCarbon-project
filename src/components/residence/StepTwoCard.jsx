...
export default function StepOneCard() {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      router.push('/register/residence-user-registration/step-three');  // Change the route to step-three
    }, 1500);
  };
      ...
      <div className="min-h-screen w-full bg-white flex flex-col items-center justify-center py-8 px-4">
        ...
        <div className="w-full max-w-md flex items-center justify-between mt-4 mb-4">
          <div className="flex-1 h-1 bg-gray-200 rounded-full mr-4">
            <div className="h-1 bg-[#039994] w-3/5 rounded-full" /> {/* Adjusted to 3/5 for step 3 of 5 */}
          </div>
          <span className="text-sm font-medium text-gray-500">03/05</span> {/* Changed to 03/05 */}
        </div>
