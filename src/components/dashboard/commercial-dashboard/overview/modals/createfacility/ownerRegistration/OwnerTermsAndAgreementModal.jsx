...
export default function OwnerTermsAndAgreementModal({ isOpen, onClose }) {
  ...
  const handleDownload = async () => {
    ...
    doc.text('COMMERCIAL OWNER REC AGREEMENT', 105, 20, { align: 'center' });
    
    doc.setFontSize(10);
    doc.setTextColor(0, 0, 0);
    
    const recText = [
      "This Commercial Owner Renewable Energy Certificate (REC) Agreement (the 'Agreement') is made",
      "between DCarbon Solutions ('Company') and the undersigned commercial property owner ('Owner').",
      "",
      "1. REC Ownership: Owner agrees to transfer all rights, title, and interest in the RECs generated",
      "by the commercial renewable energy system to Company.",
      "",
    ...
    doc.setTextColor(3, 153, 148);
    doc.setFont('helvetica', 'bold');
    doc.text('COMMERCIAL OWNER INFORMATION RELEASE', 105, yPosition, { align: 'center' });
    yPosition += 7;
    ...
    const releaseText = [
      "This Commercial Owner Information Release Authorization ('Authorization') permits DCarbon",
      "Solutions to access and use Owner's commercial utility data.",
      "",
      "1. Authorization: Owner authorizes Company to access utility account data for the commercial",
      ...
      "and provide commercial energy reports.",
      "",
      "3. Third Parties: Owner authorizes their utility provider to release consumption and",
      "generation data to Company for the commercial property.",
      "",
    ...
    doc.setFontSize(10);
    doc.setTextColor(0, 0, 0);
    doc.text('By signing below, I acknowledge that I have read and agree to both the Commercial Owner', 105, yPosition, { align: 'center' });
    yPosition += 7;
    doc.text('REC Agreement and the Commercial Owner Information Release Authorization', 105, yPosition, { align: 'center' });
    yPosition += 7;
    ...
    doc.text('Commercial Utility Account Number: _______', 40, yPosition + 30);
    
    doc.save("DCarbon_Commercial_Owner_Agreements.pdf");
  };
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="font-[600] text-[20px] leading-[100%] tracking-[-0.05em] text-[#039994] font-sans">
                  Terms of Agreement for Commercial Owner
                </h2>
              ...
              >
                <div ref={section1Ref}>
                  <h3 className="font-bold text-[#039994] mb-2">COMMERCIAL OWNER REC AGREEMENT</h3>
                  <p className="mb-4">
                    This Commercial Owner Renewable Energy Certificate (REC) Agreement (the "Agreement") is made between DCarbon Solutions ("Company") and the undersigned commercial property owner ("Owner").
                  </p>
                  <p className="mb-2"><strong>1. REC Ownership:</strong> Owner agrees to transfer all rights, title, and interest in the RECs generated by the commercial renewable energy system to Company.</p>
                  ...
                  <p className="mb-2"><strong>3. Compensation:</strong> Company shall pay Owner $0.03 per kWh for all verified RECs generated by the commercial system.</p>
                  <p className="mb-2"><strong>4. Metering:</strong> Owner agrees to provide Company with access to energy production data from the commercial renewable energy system.</p>
                  <p className="mb-2"><strong>5. Representations:</strong> Owner represents they have authority to enter this Agreement and transfer RECs for the commercial property.</p>
                  <p className="mb-4"><strong>6. Governing Law:</strong> This Agreement shall be governed by the laws of the state where the commercial property is located.</p>
                  ...
                  <div className="flex items-start mb-6">
                    ...
                    <label htmlFor="agreementCheckbox1" className="ml-3 font-sans font-[400] text-[14px] leading-[150%] text-[#039994] cursor-pointer">
                      I agree to the Commercial Owner REC Agreement
                    </label>
                  </div>
                </div>

                <div className="border-t border-gray-300 my-6 pt-6" ref={section2Ref}>
                  <h3 className="font-bold text-[#039994] mb-2">COMMERCIAL OWNER INFORMATION RELEASE AUTHORIZATION</h3>
                  <p className="mb-4">
                    This Commercial Owner Information Release Authorization ("Authorization") permits DCarbon Solutions to access and use Owner's commercial utility data.
                  </p>
                  <p className="mb-2"><strong>1. Authorization:</strong> Owner authorizes Company to access utility account data for the commercial property for REC verification and energy management services.</p>
                  <p className="mb-2"><strong>2. Data Use:</strong> Company may use this data to calculate REC production, verify system performance, and provide commercial energy reports.</p>
                  <p className="mb-2"><strong>3. Third Parties:</strong> Owner authorizes their utility provider to release consumption and generation data to Company for the commercial property.</p>
                  <p className="mb-2"><strong>4. Duration:</strong> This Authorization remains in effect until revoked in writing by Owner.</p>
                  <p className="mb-4"><strong>5. Security:</strong> Company agrees to maintain appropriate safeguards to protect Owner's data.</p>
