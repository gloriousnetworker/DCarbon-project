      ...
      {statementData?.userInfo && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div><span className="font-medium text-gray-600">Company:</span><p className="text-gray-800">{statementData.userInfo.companyName || "N/A"}</p></div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left text-black">
          ...
          <tbody className="divide-y divide-gray-200">
            ...
            )) : <tr><td colSpan="8" className="py-4 text-center text-gray-500">No sales statements found for this period</td></tr>}
          </tbody>
        </table>
      </div>
