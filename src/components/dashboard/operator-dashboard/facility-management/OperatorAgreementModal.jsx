...
export default function OwnerAndOperatorTermsAndAgreementModal({ isOpen, onClose }) {
  ...
  const handleDownload = async () => {
    ...
    doc.text('OWNER AND OPERATOR REC AGREEMENT', 105, 20, { align: 'center' });
    
    doc.setFontSize(10);
    doc.setTextColor(0, 0, 0);
    
    const recText = [
      "This Owner and Operator Renewable Energy Certificate (REC) Agreement (the 'Agreement') is made between",
      "DCarbon Solutions ('Company') and the undersigned owner and operator ('Customer').",
      "",
      "1. REC Ownership: Customer agrees to transfer all rights, title, and interest in the RECs generated",
      "by their renewable energy system to Company.",
      "",
      ...
      "",
      "3. Compensation: Company shall pay Customer $0.03 per kWh for all verified RECs generated by",
      "Customer's system.",
      "",
      ...
      "transfer RECs on behalf of the property.",
      "",
    ...
    doc.setTextColor(3, 153, 148);
    doc.setFont('helvetica', 'bold');
    doc.text('OWNER AND OPERATOR INFORMATION RELEASE', 105, yPosition, { align: 'center' });
    yPosition += 7;
    ...
    const releaseText = [
      "This Owner and Operator Information Release Authorization ('Authorization') permits DCarbon",
    ...
    doc.setFontSize(10);
    doc.setTextColor(0, 0, 0);
    doc.text('By signing below, I acknowledge that I have read and agree to both the Owner and Operator', 105, yPosition, { align: 'center' });
    yPosition += 7;
    doc.text('REC Agreement and the Owner and Operator Information Release Authorization', 105, yPosition, { align: 'center' });
    yPosition += 7;
