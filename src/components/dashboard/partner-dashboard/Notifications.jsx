...
const DashboardNotifications = () => {
  ...
  const handleToggleEmail = () => setEmailNotifications(prev => !prev);
  const handleToggleOnScreen = () => setOnScreenNotifications(prev => !prev);
  const handleToggleSystem = () => setSystemNotifications(prev => !prev);
