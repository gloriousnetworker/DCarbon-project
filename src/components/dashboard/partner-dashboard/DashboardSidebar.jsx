    ...
    <aside className={sidebarContainer}>
      ...
      <nav className="flex-1 flex flex-col space-y-1 px-2">
        ...
        <button
          ...
          className={`${menuItemBase} ${
            isActive("reporting") ? menuItemActive : menuItemInactive
          }`}
        >
          <FiZap className={iconBase} color={isActive("reporting") ? "#FFFFFF" : "#039994"} />
          <span>Reporting</span>
        </button>
        <button
          onClick={() => onSectionChange("customerManagement")}
          className={`${menuItemBase} ${
            isActive("customerManagement") ? menuItemActive : menuItemInactive
          }`}
        >
