    ...
    >
      ...
      <nav className="flex-1 flex flex-col space-y-2 px-2">
        ...
        <button
          ...
          className={`${baseItemClasses} ${
            isActive("reporting") ? activeClasses : inactiveClasses
          }`}
          style={getTextStyle(isActive("reporting"))}
        >
          <FiTrendingUp size={16} color={getIconColor(isActive("reporting"))} />
          <span>Reporting</span>
        </button>
        <button
          onClick={() => onSectionChange("customerManagement")}
          className={`${baseItemClasses} ${
            isActive("customerManagement") ? activeClasses : inactiveClasses
          }`}
          style={getTextStyle(isActive("customerManagement"))}
        >
          <FiLayers size={16} color={getIconColor(isActive("customerManagement"))} />
