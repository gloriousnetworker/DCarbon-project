...
import { FaBars, FaSearch, FaBell, FaHeadset, FaUser } from "react-icons/fa";

const DashboardNavbar = ({ toggleSidebar, selectedSection, sectionDisplayMap }) => {
  return (
    <header className="bg-white border-b border-gray-200">
      <div className="max-w-full px-4 py-3 flex items-center justify-between">
        {/* Left side: Hamburger (mobile), current section title, Sales Agent tag, Operator pending button */}
