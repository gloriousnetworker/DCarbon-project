...
const ResidentialDocuments = ({ facilityId, financeType, partnerType, onProgressUpdate }) => {
  ...
  const fetchDocuments = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `https://naijatrips-app-dcarbon-server.cafyit.easypanel.host/api/residential-facility/residential-docs/${facilityId}`,
        {
          headers: {
            Authorization: `Bearer ${authToken}`
          }
...
export default ResidentialDocuments;