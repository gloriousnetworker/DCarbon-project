...
export default function ResidentialBonusTable({ onClose, userId, authToken }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white w-full max-w-4xl rounded-md shadow-lg p-6 relative max-h-[90vh] overflow-y-auto">
        <button
          onClick={onClose}
        ...
        <h2 className={`${styles.pageTitle} text-left mb-6`}>Residential Bonus</h2>
        ...
        {bonusData.length === 0 && !loading && quarter && year && (
          <div className="text-center py-8">
            <p className="font-sfpro text-gray-500">No bonus data found for Q{quarter} {year}</p>
          </div>
        )}
