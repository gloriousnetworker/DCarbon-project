...
export default function FinanceAndInstallerModal({ isOpen, onClose, onBack }) {
  ...
  const createResidentialFacility = async () => {
    ...
    const payload = {
      nickname: facilityNickname || 'New Residential Facility',
      utilityProvider: '',
      ...
      meterId: '',
      zipCode: '',
      systemCapacity: formData.systemSize || 0,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createResidentialFacility();

      toast.success('Financial information saved and residential facility created successfully!', { id: toastId });
