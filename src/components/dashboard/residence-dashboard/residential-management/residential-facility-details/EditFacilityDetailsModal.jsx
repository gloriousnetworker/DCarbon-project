          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <button
                ...
                onClick={onClose}
                disabled={loading}
                className="w-24 px-2 py-1.5 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
                Cancel
              </button>
              <button
                ...
                className={`w-24 px-2 py-1.5 rounded-md flex items-center justify-center gap-1 ${loading ? 'bg-[#039994] opacity-50 cursor-not-allowed' : 'bg-[#039994] hover:bg-[#027d7b]'} text-white text-sm`}
              >
                {loading && (
